			                    				...
			                    				<thead style="">
			                    					<tr>
			                    						...
			                    						<th style="" data-field="check" data-align="center">
			                    							<div class="th-inner ">Check Order</div>
			                    							<div class="fht-cell"></div>
			                    						</th>
													...
													?>
			                  						<tr> 
						                                ...
						                                <td style="">
			                  							...
			                  							<td>
			                  								<button type="button" class="btn btn-round btn-warning btn-sm" onclick="window.location.href = 'history_detail.php?id=<?php echo $order_detail->id; ?>';"><i class="icon wb-order" aria-hidden="true"></i></button>
			                  							</td>
			                  						</tr>
			                  						<?php
			                  							$i++;
