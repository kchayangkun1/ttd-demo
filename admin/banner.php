...
<head>
	...
	<title>Banner Home | Back Office</title>
			                  					...
			                  					<tbody>
													...
													?>
			                  						<tr> 
			                  							...
			                  							<td style=""><?php echo date("d/m/Y", strtotime( $slide_detail->create_date ) ); ?></td>
			                  							<td>
			                  								<button type="button" class="btn btn-round btn-warning btn-sm" onclick="window.location.href = 'banner_edit.php?id=<?php echo $slide_detail->id; ?>';"><i class="icon wb-pencil" aria-hidden="true"></i></button>
