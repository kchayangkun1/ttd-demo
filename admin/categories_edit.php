...
<head>
	...
	<title>Categories Edit | Back Office </title>
...
<body class="animsition dashboard">
	...
	$cates_detail = cates_detail($_GET['id']);
			            ...
			            <div class="panel-body container-fluid">
			              	<form id="aboutusAdd" name="aboutusAdd" class="form-horizontal" method="post" enctype="multipart/form-data">
				                <div class="form-group form-material" data-plugin="formMaterial">
				                  	...
				                  	<input type="text" class="form-control" id="name" name="name" value="<?php echo $cates_detail->subcate_name; ?>" autocomplete="off" required>
				                </div>
                                <div class="form-group form-material" data-plugin="formMaterial">
									<label class="form-control-label" for="brand">Category</label>
									<?php $brand_list = cat_list(); ?>
									<select class="form-control" name="brand">
									<?php foreach ($brand_list as $brand_detail) : ?>
										<option value="<?php echo $brand_detail->c_name; ?>"<?php if($cates_detail->cate_id == $brand_detail->c_name){ echo 'selected'; } ?>><?php echo $brand_detail->c_name; ?></option>
									<?php endforeach ?>
									</select>
								</div>
				                <div class="text-right">
				                	<input type="hidden" name="slide_id" value="<?php echo $cates_detail->sub_id; ?>">
