...
<head>
	...
	<title>Today Order | Rogue Coffee </title>
		...
		{	
			if(order_edit())
			{
				echo '<script>
					...
					window.location.href = "order_today.php"
					</script>';
				exit;
			}
		}
					...
					<!-- Panel Static Labels -->
		          	<div class="panel">
			            <div class="panel-heading">
						  <h1 class="panel-title">เลขออเดอร์ : <?php echo $order_detail->order_no; ?></h1>
			            </div>
			            <div class="panel-body container-fluid">
							...
							<?php foreach ($item_list as $item_detail) : ?>
								<tr>
									...
									<td><?php echo $item_detail->product_name; ?></td>
								...
								<div class="panel-body container-fluid">
									...
									<form id="serviceAdd" name="serviceAdd" class="form-horizontal" method="post" enctype="multipart/form-data">
										<div class="text-left">
											...
											<button type="button" class="btn btn-animate btn-animate-side btn-warning btn-outline" onclick="window.location.href = 'order_today.php';">
