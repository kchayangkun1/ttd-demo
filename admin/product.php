...
<head>
	...
	<title>Product Home | Back Office</title>
...
<body class="animsition dashboard">
			                  				...
			                  				<table id="exampleTableToolbar" data-mobile-responsive="true" class="table table-hover" data-pagination="true" data-search="true" style="margin-top: 0px;">
			                    				<thead style="">
			                    					<tr>
														...
														<th style="" data-field="select" data-align="center">
			                    							<div class="th-inner ">Select Product</div>
			                    							<div class="fht-cell"></div>
			                    						</th>
			                    						<th style="" data-field="">
			                  					...
			                  					<tbody>
													...
													?>
			                  						<tr> 
														...
														<td style=""><?php echo $product_detail->cate_id; ?></td>
														<td style=""><?php echo $product_detail->subcate_name; ?></td>
														<td style=""><?php echo $product_detail->price; ?></td>
														<td style="">
														<?php if ($product_detail->is_recommend == '1') : ?>
			                  									<button class="btn btn-sm btn-success btn-icon btn-floating" type="button" onclick="sChange(<?php echo $product_detail->id; ?>, 0)"><i class="icon wb-check" aria-hidden="true"></i></button>
			                  								<?php else : ?>
			                  									<button class="btn btn-sm btn-danger btn-icon btn-floating" type="button" onclick="sChange(<?php echo $product_detail->id; ?>, 1)"><i class="icon wb-close" aria-hidden="true"></i></button>
			                  								<?php endif; ?>
			                  							</td>
			                  							...
			                  							<td>
			                  								...
			                  								<button type="button" class="btn btn-round btn-danger btn-sm" onclick="delS(<?php echo $product_detail->id; ?>)"><i class="icon wb-close" aria-hidden="true"></i></button>
			                  							</td> 
			                  						</tr>
			                  						<?php
			                  							$i++;
     ...
     function deleteService()
    {
   		$.ajax({
		  	type 	: 'POST',
		  	url 	: 'funcQuery.php',
		  	data 	: {sid:$('#s_id').val(), action:'delProducts'},
		  	success: function(data) {
		        	if (data == 'true') {
		        		location.reload();
		        	} else {
