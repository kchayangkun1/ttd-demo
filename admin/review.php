...
<head>
	...
	<title>Review Home | Back Office</title>
...
<body class="animsition dashboard">
			                  		...
			                  		<div class="fixed-table-toolbar">
			                  			<div class="bs-bars pull-left">
			                  				<div class="btn-group hidden-sm-down" id="exampleToolbar" role="group">
							                    <button type="button" class="btn btn-success btn-outline btn-sm" onclick="window.location.href = 'review_add.php';">
							                      	<i class="icon wb-plus" aria-hidden="true"></i> Add Review
							                    </button>
			                  				</div>
			                  			</div>
			                  		</div>
			                  					...
			                  					<tbody>
													...
													?>
			                  						<tr> 
			                  							...
			                  							<td style=""><?php echo $review_detail->name; ?></td>
			                  							<td style=""><?php echo date("d/m/Y", strtotime( $review_detail->create_date ) ); ?></td>
			                  							<td>
			                  								<button type="button" class="btn btn-round btn-warning btn-sm" onclick="window.location.href = 'review_edit.php?id=<?php echo $review_detail->id; ?>';"><i class="icon wb-pencil" aria-hidden="true"></i></button>
			                  								<button type="button" class="btn btn-round btn-danger btn-sm" onclick="delS(<?php echo $review_detail->id; ?>)"><i class="icon wb-close" aria-hidden="true"></i></button>
			                  							</td> 
			                  						</tr>
			                  						<?php
			                  							$i++;
     ...
     function deleteService()
    {
   		$.ajax({
		  	type 	: 'POST',
		  	url 	: 'funcQuery.php',
		  	data 	: {sid:$('#s_id').val(), action:'delReview'},
		  	success: function(data) {
		        	if (data == 'true') {
		        		location.reload();
		        	} else {
