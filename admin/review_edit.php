...
<head>
	...
	<title>Review Edit | Back Office </title>
			            ...
			            <div class="panel-body container-fluid">
			              	<form id="aboutusAdd" name="aboutusAdd" class="form-horizontal" method="post" enctype="multipart/form-data">
								...
								<div class="form-group form-material form-material-file" data-plugin="formMaterial">
			                      	...
			                      	<input type="file" id="covImg" name="covImg" data-plugin="dropify" data-default-file="<?php echo '../assets/images/review/' . $review_detail->id . '/' . $review_detail->img_cover; ?>" data-allowed-file-extensions="png jpg"/>
									<p class="help-block"><i>Image size: 1950x900px</i></p>
				                </div>
				                <div class="text-right">
				                	<input type="hidden" name="logo_id" value="<?php echo $review_detail->id; ?>">
						            ...
						            <button type="button" class="btn btn-animate btn-animate-side btn-default btn-outline" onclick="window.location.href = 'review.php';">
