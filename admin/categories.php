...
<body class="animsition dashboard">
			                    				...
			                    				<thead style="">
			                    					<tr>
			                    						...
			                    						<th style="" data-field="name">
			                    							<div class="th-inner ">SubCategories Name</div>
			                    							<div class="fht-cell"></div>
			                    						</th>
			                  					...
			                  					<tbody>
													...
													?>
			                  						<tr> 
			                  							...
			                  							<td style=""><?php echo $cates_detail->subcate_name; ?></td>
                                                        <td style=""><?php echo $cates_detail->cate_id; ?></td>
			                  							<td style=""><?php echo date("d/m/Y ", strtotime( $cates_detail->create_date ) ); ?></td>
			                  							<td>
			                  								<button type="button" class="btn btn-round btn-warning btn-sm" onclick="window.location.href = 'categories_edit.php?id=<?php echo $cates_detail->sub_id; ?>';"><i class="icon wb-pencil" aria-hidden="true"></i></button>
			                  								<button type="button" class="btn btn-round btn-danger btn-sm" onclick="delS(<?php echo $cates_detail->sub_id; ?>)"><i class="icon wb-close" aria-hidden="true"></i></button>
			                  							</td> 
			                  						</tr>
			                  						<?php
			                  							$i++;
     ...
     function deleteSlide()
    {
   		$.ajax({
		  	type 	: 'POST',
		  	url 	: 'funcQuery.php',
		  	data 	: {sid:$('#s_id').val(), action:'delCateies'},
