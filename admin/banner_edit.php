...
<head>
	...
	<title>Edit Banner Slide | Back Office </title>
					...
					<!-- Panel Static Labels -->
		          	<div class="panel">
			            <div class="panel-heading">
			              <h3 class="panel-title">Edit Banner Slide</h3>
			            </div>
			            <div class="panel-body container-fluid">
			              	<form id="aboutusAdd" name="aboutusAdd" class="form-horizontal" method="post" enctype="multipart/form-data">
				                <div class="form-group form-material" data-plugin="formMaterial">
				                  	...
				                  	<input type="text" class="form-control" id="name" name="name" value="<?php echo $slide_detail->name; ?>" required>
				                </div>
								<div class="form-group form-material form-material-file" data-plugin="formMaterial">
				                  	<label class="form-control-label" for="image">Image</label>
			                      	<input type="file" id="covImg" name="covImg" data-plugin="dropify" data-default-file="<?php echo '../assets/images/banner/' . $slide_detail->id . '/' . $slide_detail->img_cover; ?>" data-allowed-file-extensions="png jpg"/>
