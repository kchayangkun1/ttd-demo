...
<head>
	...
	<title>Category Edit | Back Office </title>
			            ...
			            <div class="panel-body container-fluid">
			              	<form id="aboutusAdd" name="aboutusAdd" class="form-horizontal" method="post" enctype="multipart/form-data">
				                <div class="form-group form-material" data-plugin="formMaterial">
				                  	...
				                  	<input type="text" class="form-control" id="name" name="name" value="<?php echo $cat_detail->c_name; ?>" autocomplete="off" required>
				                </div>
				                <div class="text-right">
				                	<input type="hidden" name="slide_id" value="<?php echo $cat_detail->id; ?>">
