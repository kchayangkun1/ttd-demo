...
<head>
	...
	<title>Add Product | Back Office </title>
			            ...
			            <div class="panel-body container-fluid">
			              	<form id="serviceAdd" name="serviceAdd" class="form-horizontal" method="post" enctype="multipart/form-data">
									...
									<label class="form-control-label" for="category">Category</label>
										<select class="form-control" name="sub_cate" required>
											...
											<optgroup label="<?php echo $category_detail->c_name ;?>">                         
												...
												<option value="<?php echo $subcate_detail->sub_id; ?>"><?php echo $subcate_detail->subcate_name; ?></option>
												<?php endforeach; ?>
											</optgroup>
											<?php endforeach; ?>
										</select>
								...
								<div class="form-group form-material form-material-file" data-plugin="formMaterial">
									...
									<p class="help-block"><i>Image size: 800x800px</i></p>
				                </div>
								<div class="form-group form-material form-material-file" data-plugin="formMaterial">
				                  	<label class="form-control-label" for="image">Images</label>
				                  	<input type="file" id="pdImg" name="pdImg">
									<p class="help-block"><i>Image size: 1500x1125px</i></p>
				                </div>
