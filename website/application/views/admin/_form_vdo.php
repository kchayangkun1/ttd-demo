			...
			<div class="row" data-plugin="matchHeight" data-by-row="true">
				<div class="col-xxl-12 col-lg-12">		
					<!-- Panel Static Labels -->
		          	<div class="panel">
			            <div class="panel-heading">
			              <h3 class="panel-title">วิดีโอ</h3>
			            </div>
			            <div class="panel-body container-fluid">
			              	<form action="<?=base_url('Admin/vdo_create');?>" id="serviceAdd" name="serviceAdd" class="form-horizontal" method="post" enctype="multipart/form-data">
                    ...
                    value="<?=$this->security->get_csrf_hash();?>" >
				                ...
				                <div class="form-group form-material" data-plugin="formMaterial">
				                  	<label class="form-control-label" for="link_video" title="คัดลอก url youtube วางที่นี่">ลิ้งค์วิดีโอ</label>
				                  	<input type="url" class="form-control" id="link_video" name="link_video" placeholder="Link Video" title="คัดลอก url youtube วางที่นี่" required>
				                </div>
				                <div class="text-right">
						            ...
						            <button type="button" class="btn btn-animate btn-animate-side btn-default btn-outline" onclick="window.location.href = 'video.php';">
						              	<span><i class="icon wb-close" aria-hidden="true"></i> ยแกเลิก</span>
						            </button>
          						</div>
			              	</form>
			            </div>
