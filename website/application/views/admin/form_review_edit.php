...
<head>
	...
	<title>Edit Review | glovepfs </title>
				...
				<div class="col-xxl-12 col-lg-12">		
					<!-- Panel Static Labels -->
		          	<div class="panel">
			            ...
			            <div class="panel-body container-fluid">
			              	<form action="<?=base_url('Admin/review_update');?>" id="aboutusAdd" name="aboutusAdd" class="form-horizontal" method="post" enctype="multipart/form-data">
				                <div class="form-group form-material" data-plugin="formMaterial">
				                  	<label class="form-control-label" for="title">Name</label>
				                  	<input type="text" class="form-control" id="name" name="name" value="<?=$review_detail[0]['name']; ?>" required>
                    ...
                    value="<?=$this->security->get_csrf_hash();?>" >
								...
								<div class="form-group form-material form-material-file" data-plugin="formMaterial">
									  ...
									  data-default-file="<?=base_url('./assets/images/review/'.$review_detail[0]['id'].'/'. $review_detail[0]['img_cover']);?>" data-allowed-file-extensions="png jpg jpeg PNG JPG JPEG"/>
									<p class="help-block"><i>Image size: 750X750px</i></p>
				                </div>

				                <div class="text-right">
				                	<input type="hidden" name="rw_id" value="<?=$review_detail[0]['id']; ?>">
						            ...
						            <button type="button" class="btn btn-animate btn-animate-side btn-default btn-outline" onclick="window.location.href = '<?=base_url('Admin/list_reviews');?>';">
