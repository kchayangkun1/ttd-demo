...
<head>
	...
	<title>Slide Add | Lenista Clinic </title>
				...
				<div class="col-xxl-12 col-lg-12">		
					<!-- Panel Static Labels -->
		          	<div class="panel">
			            ...
			            <div class="panel-body container-fluid">
			              	<form action="<?=base_url('Admin/bannerCreate');?>" id="serviceAdd" name="serviceAdd" class="form-horizontal" method="post" enctype="multipart/form-data">
                    ...
                    value="<?=$this->security->get_csrf_hash();?>" >
								...
								<div class="form-group form-material" data-plugin="formMaterial">
				                  	...
				                  	<input type="url" class="form-control" id="alink" name="alink" placeholder="Link">
				                </div>
