					...
					<!-- Panel Static Labels -->
		          	<div class="panel">
			            ...
			            <div class="panel-body container-fluid">
			              	<form action="<?=base_url('Admin/update_subcategory');?>" id="aboutusAdd" name="aboutusAdd" class="form-horizontal" method="post" enctype="multipart/form-data">
				                <div class="form-group form-material" data-plugin="formMaterial">
				                  	<label class="form-control-label" for="title">Categories Name</label>
				                  	<input type="text" class="form-control" id="name" name="name" value="<?=$cates_detail[0]['subcate_name']; ?>" autocomplete="off" required>
                                ...
                                <div class="form-group form-material" data-plugin="formMaterial">
									...
									<?php foreach ($brand_list as $brand_detail) : ?>
										<option value="<?=$brand_detail['c_name']; ?>"<?php if($cates_detail[0]['cate_id'] == $brand_detail['c_name']){ echo 'selected'; } ?>><?=$brand_detail['c_name']; ?></option>
									<?php endforeach ?>
									</select>
								</div>
				                <div class="text-right">
				                	<input type="hidden" name="sub_id" value="<?=$cates_detail[0]['sub_id']; ?>">
